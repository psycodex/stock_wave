...
class NumberSortingServiceApi {
  ...
  $async.Future<NumberArray> sortNumbers($pb.ClientContext? ctx, NumberArray request) =>
    _client.invoke<NumberArray>(ctx, 'NumberSortingService', 'SortNumbers', request, NumberArray())
  ;
}
